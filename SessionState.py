# https://gist.github.com/FranzDiebold/898396a6be785d9b5ca6f3706ef9b0bc#file-sessionstate-py
# https://discuss.streamlit.io/t/two-people-on-same-session-state/3211/9
...
def get(**kwargs):
    ...
    **kwargs : any
    ...
    temp = ReportThread.get_report_ctx()
